...
class BaseConfig:
    ...
    ACCESS_KEY_ID = 'LTAI5tD7qmR6uQtaG3Mqvqmp'
    ACCESS_KEY_SECRET = 'VmHEaJbwuaELgmschrHPBwoPf5TAdh'
    ENDPOINT = 'oss-cn-shanghai.aliyuncs.com'
    BUCKET_NAME = 'speech-zyr'

    # JSON配置
    JSON_AS_ASCII = False

    SECRET_KEY = "zyr_ctc_speech"

    #mysql 配置
    MYSQL_USERNAME = "root"
    MYSQL_PASSWORD = "335060"
    MYSQL_HOST = "122.51.134.85"
    MYSQL_PORT = 3306
    MYSQL_DATABASE = "zyr_ctc_speech"
    ...
    MAIL_USE_SSL = False
    MAIL_PORT = 587
    MAIL_USERNAME = 'datamphaypettengillov2490@gmail.com'
    MAIL_PASSWORD = '8444 1180'  # 生成的授权码
